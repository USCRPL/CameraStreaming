...
Dword Demodulator_checkChipType (
    ...
    return (Standard_checkChipType (demodulator, chip, chip_Type, chip_version));
}
...
Dword Demodulator_setDcaLatchTime(
	...
	return (Standard_setDcaLatchTime(demodulator, masterValue, slaveValue));
}
...
Dword Demodulator_acquireChannelEx(
	...
	return (Standard_acquireChannelEx(demodulator, bandwidth, masterFreq, slaveFreq));
