...
#include "error.h"
#include "cmd.h"
/* For driver, not include these & implement */
/*
#include "i2cimpl.h"
#include "spiimpl.h"
#include "sdioimpl.h"
...
#define Tuner_AnalogDevices_ADMTV803        0x37
#define Tuner_Afatech_OMEGA                 0x38
#define Tuner_Afatech_ORION                 0x39
#define Tuner_Afatech_ORION_12M				0x3A
#define Tuner_FCI_FC2580_12M                0x40
#define Tuner_Maxlinear_MXL5007             0x41
#define Tuner_Philips_FQD1116ME		        0x42
#define Tuner_FCI_FC2580_26M                0x43
#define Tuner_NuTune_VP4600                 0x44
#define Tuner_Philips_TDA18273              0x45
#define Tuner_Afatech_ORIONV57A             0x46
#define Tuner_Afatech_ORIONV57B             0x47
#define Tuner_Afatech_PICTORV32             0x48
...
#define Tuner_Afatech_OMEGA_V2              0x60 // 0x60~0x6f reserved for OMEGA V2use
#define Tuner_Afatech_OMEGA_V2_LNA_Config_1	0x61 
#define Tuner_Afatech_OMEGA_V2_LNA_Config_2 0x62
#define Tuner_Afatech_OMEGA_V2_LNA_Config_3 0x63
#define Tuner_Afatech_OMEGA_V2_LNA_Config_4 0x64
#define Tuner_Afatech_OMEGA_V2_LNA_Config_5 0x65
#define Tuner_Afatech_SAMBA                 0x70
#define Tuner_Afatech_SAMBA_Config_1        0x71
 ...
 *     error = Demodulator_setBusTuner ((Demodulator*) &it9130, Bus_I2C, Tuner_MICROTUNE_MT2060);
 *     if (error) 
 ...
 *
 *     // Set frequencies. 
 *     error = Demodulator_setCrystalAdcFrequency ((Demodulator*) &it9130, 30000, 20156250);
 *     if (error) 
 *         printf ("Error Code = %X", error);
 *     else
 *         printf ("Success");
 ...
 *     Dword partitions[256];
 *     ValueSet scripts[256];
 *     ValueSet tunerScripts[256];
 *     IT9130 it9130;
 *
 *     // Set I2C as the control bus. 
 *     error = Demodulator_setFirmwareScript ((Demodulator*) &it9130, firmware, segments, partitions, 65535, scripts, 256, tunerScripts, 256);
 *     if (error) 
 *         printf ("Error Code = %X", error);
 *     else
 *         printf ("Success");
 ...
 *
 *     // Set statistic range. 
 *     error = Demodulator_getChannelStatistic ((Demodulator*) &it9130, 0, &channelStatistic);
 *     if (error) 
 *         printf ("Error Code = %X", error);
 *     else
 *         printf ("Success");
...
/**
 * Set af9035u2i bus i2c group
 *
 * @param demodulator the handle of demodulator.
 * @param group the number of i2cgroup.
 * @param minorVersion the number of tuner minor version.
 * @return Error_NO_ERROR: successful, non-zero error code otherwise.
 * @example <pre>
 * </pre>
 */
Dword Demodulator_set9035u2iI2CInterface (
    IN  Demodulator*    demodulator,
